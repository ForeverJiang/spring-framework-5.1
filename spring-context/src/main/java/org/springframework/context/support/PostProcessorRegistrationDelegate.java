...
final class PostProcessorRegistrationDelegate {
    ...
    public static void invokeBeanFactoryPostProcessors(
        ...
        /**
         * 共有三个list：BeanFactoryPostProcessor -- regularPostProcessors、
         * BeanDefinitionRegistryPostProcessor -- registryProcessors、
         * currentRegistryProcessors -- currentRegistryProcessors
         *
         * BeanDefinitionRegistryPostProcessor 也是实现了  BeanFactoryPostProcessor 是子类
         */
        if (beanFactory instanceof BeanDefinitionRegistry) {
            ...
            for (BeanFactoryPostProcessor postProcessor : beanFactoryPostProcessors) {
                /**
                 * 如果postProcessor是BeanDefinitionRegistryPostProcessor，
                 * 则调用postProcessBeanDefinitionRegistry对beanFactory进行处理。然后加入registryPostProcessors
     ...
     */
    /**
     * 这里分别调用了每个BeanDefinitionRegistryPostProcessor的postProcessBeanDefinitionRegistry方法
     *
     ...
     */
    /**
     * 这里分别调用了每个BeanFactoryPostProcessor的postProcessBeanFactory方法。
     *
     * @param postProcessors
     * @param beanFactory
     */
